...
//         <Link to={`/`} className=""> <a className="btn btn-ghost text-2xl text-center font-bold">   <img className='w-10 h-10' src={Job} alt="" /> <span className=" text-yellow-600">WD</span> <span className=" text-green-600">Jobs </span> </a></Link> 
// 		</div>
